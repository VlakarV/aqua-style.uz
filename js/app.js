        ...
        function initSliders() {
            ...
            if (document.querySelector(".swiper")) {
                new core(".swiper", {
                    ...
                    navigation: {
                        prevEl: ".area-slider-button-prev",
                        nextEl: ".area-slider-button-next"
                    },
                    breakpoints: {
                        320: {
                            slidesPerView: 1,
...
***************************************************************************** */
        ...
        const containHide = () => header.classList.contains("_header-hide");
        window.addEventListener("scroll", (() => {
            if (scrollPosition() > lastScroll && !containHide() && scrollPosition() > defaultOffset) header.classList.add("_header-hide"); else if (scrollPosition() < lastScroll && containHide()) header.classList.remove("_header-hide");
